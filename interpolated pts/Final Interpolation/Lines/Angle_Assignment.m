function [angle_op]=Angle_Assignment(feature, feature_leng, feature_x_center, feature_y_center, traced, angle_op)
    ...
    exception_sample9 = -1;     exception_sample8 = -1;
    ...
    while k < rows
        if feature(k,1)~= 0 &&  feature(k,2)~= 0
         ...
         %   fprintf('\n Data are: (%d, %d)', feature(k,1), feature(k,2));
            ...
            %CASE: Exception for sample8.png
            if  X_cl==73 && Y_cl==132  
            ...
            end %CASE: Exception for sample8.png
            ...
            %CASE-2
            if Yc < Y_cl && exception_sample9 ~=1   &&  exception_sample8 ~=1
