function [len]= new_Degree_0(i,j, ip_ang, feature)
    ...
    if j <= (c-1) %IF CURRENT LOCATION IS NOT BORDER
      ...
      while (flag~=1)
           % fprintf('\n i= %d and j= %d \n', i, j);
           if j>= (c-1)   %Stopping Criteria for if traversal reaches border of image 
                    flag=1;
                    border=1;                
                    len=0;
                    break;
