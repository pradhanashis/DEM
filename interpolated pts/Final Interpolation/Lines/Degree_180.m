function [len]= Degree_180(i,j, ip_ang, feature)
    ...
    if j >= 2 %IF CURRENT LOCATION IS NOT BORDER
    ...
    while (flag~=1)
            ...
            if j<=2 %Stopping Criteria for if traversal reaches border of image 
                        flag=1;
                        border=1;                
                        len=0;
                        break;
            ...
            if tmp(5)==0            
                    len=len+1;
                    i=i;  j=j-1; %Update coodinate value               
            end        
