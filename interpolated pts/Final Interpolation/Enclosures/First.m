...
while image_center_flag~=1
    ...
    [row, col,image_center_flag]=spiral(ip, image_center_flag);
     ...
     fprintf('\n Start Cood: row=%d and col=%d', start_r, start_c); 
     ...
     xc=line_x/count;      yc=line_y/count;
...
imwrite(interpolated_pt,'interpolated_pt.png');
...
imwrite(op,'C:\Users\Mr. Ashis Pradhan\Documents\MATLAB\Final Interpolation\Enclosures\en_op\Enclosure_op.png');
%imtool(op);
